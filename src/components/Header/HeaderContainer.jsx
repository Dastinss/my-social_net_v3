...
class HeaderContainer extends React.Component { //классовая компонента должна обязательно раширять базовый класс реакт компонеты и обязательно должна в методе рендер jsx
    // componentDidMount() { // #80 перенесли в Арр. Это метод жизненного цикла компоненты. в этом методе НУЖНО делать все сайд=эффекты. Компонента монтирует страничку только один раз
    //     this.props.getAuthUserData();

        // в уроке 67 перенесли в authReducer
        // authAPI.me() // вернет нам промис
        //     // #67 перенесли в api
...
export default connect( mapStateToProps, { logout } )( HeaderContainer ); //78 добавил АС который мы создали для ВЫлогинивания